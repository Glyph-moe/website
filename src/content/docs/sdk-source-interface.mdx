...
<Callout type="note">
  The app automatically sanitizes chapter HTML before displaying it. Scripts, event handlers,
  iframes, and inline styles are stripped for security.
</Callout>
...
<Callout type="warning" title="Important">
  Include `tags` in your items so the app can filter by content rating. Without tags, the app cannot
  detect adult/mature content.
</Callout>
